...
public class FigureDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Intent intentService = new Intent(com.example.finalproject.FigureDetails.this,MusicService.class);
        ...
        final EditText star_tv = (EditText)findViewById(R.id.figure_star);
        final EditText nickname_tv = (EditText)findViewById(R.id.figure_nickname);
        final EditText origin_tv = (EditText)findViewById(R.id.figure_origin);

        //修改字体
        Typeface type = Typeface.createFromAsset(this.getAssets(), "gufeng.TTF");
        name_tv.setTypeface(type);
        life_tv.setTypeface(type);
        star_tv.setTypeface(type);
        nickname_tv.setTypeface(type);
        origin_tv.setTypeface(type);

        TextView tv1 = (TextView) findViewById(R.id.befor_life);
        TextView tv2 = (TextView) findViewById(R.id.before_star);
        TextView tv3 = (TextView) findViewById(R.id.before_nickname);
        TextView tv4 = (TextView) findViewById(R.id.before_origin);
        ...
        if(position==-1){//新增加的空人物
            ...
            star_tv.setHint("点击此处输入天罡地煞");
            nickname_tv.setHint("点击此处输入绰号");
            ...
            star_tv.setFocusableInTouchMode(true);
            star_tv.setFocusable(true);
            nickname_tv.setFocusable(true);
            nickname_tv.setFocusableInTouchMode(true);
            ...
            star_tv.setText(figure.getStar());
            nickname_tv.setText(figure.getNickname());
            origin_tv.setText(figure.getOrigin());
            if(figure.getPicPath()==null) {
                Resources res = com.example.finalproject.FigureDetails.this.getResources();
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                figure.setStar(star_tv.getText().toString());
                figure.setNickname(nickname_tv.getText().toString());
           ...
           //     Toast.makeText(FigureDetails.this,"name:"+String.valueOf(figure.getName())+" 主效势力:"+String.valueOf(figure.getMainCountry()), Toast.LENGTH_SHORT).show();
                ...
                star_tv.setFocusableInTouchMode(false);
                star_tv.setFocusable(false);
                nickname_tv.setFocusable(false);
                nickname_tv.setFocusableInTouchMode(false);
